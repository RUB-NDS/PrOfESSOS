...
//		logger.log("release browser lock");
	...
	@Nullable 
	protected Nonce getAuthReqNonce() {return null;}
	
	@Nullable 
	protected ResponseMode getAuthReqResponseMode() {return null;}
	
	@Nullable 
	protected Prompt getAuthReqPrompt() {return null;}
	
	@Nullable 
	protected ClaimsRequest getAuthReqClaims() {return null;}
	//
...
//		claims.addIDTokenClaim("middle_name");
	@Nullable 
	protected CodeChallenge getCodeChallenge() {return null;}
	
	@Nullable 
	protected JWT getIdTokenHint() {return null;}
