...
public class RPParameterConstants {
	...
	public static final String TOKEN_RECEIVAL_FAILS_TEST = "code-redemption-fails-test";
	...
	public static final String FORCE_HONEST_CLIENT_ID = "force_honest_client_id";
	public static final String FORCE_EVIL_CLIENT_SECRET = "force_evil_client_secret";
	public static final String FORCE_HONEST_CLIENT_SECRET = "force_honest_client_secret";
	...
	public static final String AUTHNREQ_ADD_INVALID_SCOPE = "authnreq-add-invalid-scope";
	...
	public static final String TOKENREQ_FORCE_HONEST_REDIRURI = "tokenreq-force-honest-redirect-uri";
	...
	public static final String TOKENREQ_FORCE_NO_CLIENT_AUTH = "tokenreq-force-no-client-auth";
	...
	public static final String TOKENREQ_CLIENTAUTH_EXCL_ID = "tokenreq-clientauth-exclude-client-id";
	public static final String TOKENREQ_CLIENTAUTH_EMPTY_SECRET = "tokenreq-clientauth-empty-client-secret";
	public static final String TOKENREQ_CLIENTAUTH_EXCL_SECRET = "tokenreq-clientauth-exclude-client-secret";
